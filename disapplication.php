...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Manage Application Forms </h1>
</div>
...
<div class="row d-flex justify-content-center">
    ...
    <tbody> 
     <tr> 
            ...
            <td><a href ="accepapp.php?app_id=<?php echo $row['app_id'];?>
            ...
            &10%=<?php echo $row['10%'];?>
            &12%=<?php echo $row['12%'];?>
            &graduation%=<?php echo $row['graduation%'];?>
            &c_name=<?php echo $row['c_name'];?>
            &c_id=<?php echo $row['c_id'];?>
            &address=<?php echo $row['address'];?>" class ="btn btn-primary">Accept</a></td>
            <td><a href ="reject.php?app_id=<?php echo $row['app_id']; ?>
            &firstname=<?php echo $row['firstname'];?>
            &lastname=<?php echo $row['lastname'];?>
            &fname=<?php echo $row['fname'];?>
            &dob=<?php echo $row['dob'];?>
            ...
            &c_name=<?php echo $row['c_name'];?>
            &c_id=<?php echo $row['c_id'];?>
            &address=<?php echo $row['address'];?>" class ="btn btn-danger">Reject</a></td>
            </tr>
             <?php   
            }
