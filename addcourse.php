...
if(mysqli_num_rows($duplicate) > 0){
    ...
    alert('course Already Exists.....');
        ...
        $query= "INSERT INTO course VALUES('$c_id','$year','$c_name','$duration','$fees','$intake','','$v_seats','$c_type')";
...
<div class="row d-flex justify-content-center">
    ...
    <div class="form-main" id="stform">
        ...
        <input type="intake" class="form-control" name="intake" id="intake" required value=""  autocomplete="off" pattern="[0-9]{1,20}" title="Please enter valid number"></div>
        <div class="col-md-3 mb-3">
        <label for="intake">Vacant Seats : </label>
        <input type="intake" class="form-control" name="v_seats" id="v_seats" required value=""  autocomplete="off" pattern="[0-9]{1,20}" title="Please enter valid number"><br>
                        </div></div>
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
