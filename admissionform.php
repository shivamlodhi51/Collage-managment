...
<head>
   ...
   <script src="https://code.jquery.com/jquery-3.5.1.min.js" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        {
            var state = document.getElementById("parent_selection").value;
            if(state == "it" || state == "cse" || state == "civil" || state == "mc"){
                                    ...
                                    <div class="form-main" id="stform">
                                        <div class="container">
                                            <div class="row-cols-1 blanks">
                                                ...
                                                <form action="admissionformconn.php" method="post">
                                                    ...
                                                    <div class="col-md-2 mb-3">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="firstname"
                                                                id="validationDefault01" value=""  class="help"  autocomplete="off" aria-describedby="name-format"  required aria-required="true" pattern="[A-Za-z]{1,13}" title="please enter valid name without space or $,@">
                                                    
                                                        </div>
                                                        <div class="col-md-4 mb-3">
                                                            <label for="validationDefault02">Last Name : </label>
                                                            <input type="text" class="form-control" name="lastname"
                                                                id="validationDefault02" value="" required  class="help"  autocomplete="off" aria-describedby="name-format"  required aria-required="true" pattern="[A-Za-z]{1,13}" title="please enter valid name without space or $,@">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="email" value=""
                                                                required  name="fname"  class="help"  autocomplete="off" aria-describedby="name-format"  required aria-required="true" pattern="[A-Za-z ]{1,13}" title="please enter valid name without space or $,@">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <input type="tel" class="form-control" id="phone" value=""
                                                             name="num" required  minlength="10" maxlength="10" autocomplete="off" pattern="[6-9]{1}[0-9]{9}" title="Please enter valid number">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <input type="date" id="dob" required name="dob" value="" class="form-control">
                                                ...
                                                <select id="gender" required name="gender" value="" class="form-control">
                                                ...
                                                <select id="category"  name="category" value="" class="form-control"  autocomplete="off">
                                                    <option value="">Please select</option>
                                                ...
                                                <select name="parent_selection" id="parent_selection" class="form-control" value="" onchange="changeDropdown(this.value);">
                                                    <option value="">Please select</option>
                                                ...
                                                <select name="child_selection" id="child_selection" disabled="disabled" class="form-control"></select>
                                                        ...
                                                        <div class="col-md-3 mb-3" id="hide">
                                                            <label for="Phone">Graduation Percentage : </label>
                                                            <input type="text" class="form-control" id="graduation" value=""
                                                                    name="graduation%" autocomplete="off" >
