                        ...
                        <div id="content">
                            ...
                            <div class="container-fluid">
                               ...
                               <div class="row">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                    <div class="text-xl font-weight-bold text-primary text-uppercase mb-1">Total Courses</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <?php
                                        $conn = mysqli_connect("localhost","root","","p");
                                        $query = "select c_id from course";
                                        $query_run =mysqli_query($conn,$query);
                                    ...
                                    <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                    <div class="text-xl font-weight-bold text-primary text-uppercase mb-1">Total Application Forms</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <?php
                                        $conn = mysqli_connect("localhost","root","","p");
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <?php
                                        $conn = mysqli_connect("localhost","root","","p");
                                        $query = "select app_id from feedback";
                                        $query_run =mysqli_query($conn,$query);
