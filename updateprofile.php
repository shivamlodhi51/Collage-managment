                                    ...
                                    <div class="form-main" id="stform">
                                        <div class="container">
                                            <div class="row-cols-1 blanks">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="update_firstname"
                                                                id="validationDefault01" value="<?php echo $row['firstname']; ?>"  required class="help"  autocomplete="off" aria-describedby="name-format"  required aria-required="true" pattern="[A-Za-z]{1,13}" title="please enter valid name without space or $,@">
                                                    
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="validationDefault02">Last Name : </label>
                                                            <input type="text" class="form-control" name="update_lastname"
                                                                id="validationDefault02" value="<?php echo $row['lastname']; ?>" required  class="help"  autocomplete="off" aria-describedby="name-format"  required aria-required="true" pattern="[A-Za-z]{1,13}" title="please enter valid name without space or $,@">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="email" value="<?php echo $row['email']; ?>"
                                                                required  name="update_email">
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <label for="Phone">Phone Number : </label>
                                                            <input type="tel" class="form-control" id="phone" value="<?php echo $row['num']; ?>"
                                                                required  minlength="10"  name="update_no" autocomplete="off" pattern="[6-9]{1}[0-9]{9}" title="Please enter valid number"> 
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <label for="dob">Date Of Birth : </label>
                                                            <input class="form-control" type="date" id="dob" required name="update_dob" value="<?php echo $row['dob']; ?>" autocomplete="off">
                                                ...
                                                <select id="gender" required name="update_gender" value="" class="form-control">
                                                    ...
                                                    <button class="btn btn-primary" type="submit" name="updateprofile">Save Changes</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
