...
if(mysqli_num_rows($duplicate) > 0){
    echo "<script>alert('Your Feedback is already submitted...'); window.location.href='profile.php';</script>";
}
else{

$query= "INSERT INTO feedback VALUES('','$app_id','$desc',CURRENT_TIMESTAMP)";
        mysqli_query($conn,$query);
        echo "<script>alert('Your Feedback is successfully submitted...'); window.location.href='profile.php';</script>";
    }
}
                        ...
                        <li class="nav-item active">
                            ...
                            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                                ...
                                <div class="bg-white py-2 collapse-inner rounded">
                                    ...
                                    <a class="collapse-item " href="stfeedback.php">Feedback Form</a>
                                </div>
                            </div>
                        </li>
                                            ...
                                            <div class="row-cols-1 blanks">
                                                ...
                                                <form action="" method="post">
                                                    <div class="form-row">
                                                      ...
                                                      <input type="text" class="form-control" name="app_id" id="app_id" readonly value="<?php echo $row["id"];?>"><br>
                                                        </div>
                                                        </div>
                                                        
                                                        <div class="col-md-20 mb-3">
                                                        <label for="desc">Description :</label>
                                                        <textarea class="form-control" rows="7" column="20" name="desc" id="desc" required value="" placeholder="Write Feedback Here"></textarea>
