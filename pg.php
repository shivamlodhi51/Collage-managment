...
require 'connection.php';
  ...
  $result2 = mysqli_query($conn, "SELECT * FROM course where c_type='pg' ");
...
<li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem" class="breadcrumb-item"><span itemprop="name">Courses</span>				<meta itemprop="position" content="1">
    ...
    <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem" class="breadcrumb-item active"><span itemprop="name">Post Graduate</span>				<meta itemprop="position" content="2">
</li>
</ol>
</div></div></div></div></div>
            </div>
