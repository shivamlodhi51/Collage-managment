                        ...
                        <li class="nav-item active">
                            ...
                            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                                ...
                                <div class="bg-white py-2 collapse-inner rounded">
                                    ...
                                    <a class="collapse-item " href="displayfeedback.php">feedback</a>
                                </div>
                            </div>
                        </li>
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item dropdown no-arrow">
                                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                            ...
                                            <span class="mr-2 d-none d-lg-inline text-gray-600 small">Shivam
                                                lodhi</span>
...
<div class="row d-flex justify-content-center">
    ...
    <div class="form-main" id="stform">
        ...
        <input type="c_id" class="form-control" name="c_id" id="c_id" required value=""><br>
                            
                        </div>
                        <div class="col-md-6 mb-3">
                        <label for="year">Year Of Start: </label>
        <input type="year" class="form-control" name="year" id="year" required minlength="4"><br>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                        <label for="name">Course name: </label>
        <input type="text" class="form-control" name="c_name" id="c_name" required value=""><br>
                               
                        </div>
                        
                        <div class="col-md-3 mb-3">
                        <label for="duration">Course Duration: </label>
        <input type="duration" class="form-control" name="duration" id="duration" required value=""><br>
                        </div>
                        <div class="col-md-3 mb-6">
                        <label for="fees">Course fees: </label>
        <input type="fees" class="form-control" name="fees" id="fees" required value=""><br>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="intake">Intake: </label>
        <input type="intake" class="form-control" name="intake" id="intake" required value=""><br>
                        </div>
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
                    ...
                    <button class="btn btn-primary" type="csubmitc" name="csubmitc">Submit form</button>
                    <button class="btn btn-success"><a href="admindash.php"></a>back</button>
                </form>
            </div>
        </div>
    </div>
