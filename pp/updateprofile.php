                        ...
                        <li class="nav-item active">
                            ...
                            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                                ...
                                <div class="bg-white py-2 collapse-inner rounded">
                                    ...
                                    <a class="collapse-item " href="#">Feedback Form</a>
                                </div>
                            </div>
                        </li>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="update_firstname"
                                                                id="validationDefault01" value="<?php echo $row['firstname']; ?>"  required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="validationDefault02">Last Name : </label>
                                                            <input type="text" class="form-control" name="update_lastname"
                                                                id="validationDefault02" value="<?php echo $row['lastname']; ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="col-md-6 mb-3">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="phone" value="<?php echo $row['num']; ?>"
                                                                required  minlength="10"  name="update_no">
                                                        </div>
                                                        <div class="col-md-3 mb-3">
