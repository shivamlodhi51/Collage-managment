...
<div class="row d-flex justify-content-center">
    ...
    <tbody> 
     <tr> 
            ...
            <td><a href ="accepapp.php?app_id=<?php echo $row['app_id']; ?>" class ="btn btn-primary">Accept</a></td>
            <td><a href ="reject.php?app_id=<?php echo $row['app_id']; ?>" class ="btn btn-danger">Reject</a></td>
            </tr>
