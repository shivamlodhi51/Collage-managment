...
if(!empty($_SESSION["id"])){
    ...
    // $rej = mysqli_query($conn, "SELECT * FROM rejected where app_id = $id");
    $row = mysqli_fetch_assoc($result);
    $approw = mysqli_fetch_assoc($app);
    $strow = mysqli_fetch_assoc($st);
    // $rejrow = mysqli_fetch_assoc($rej);
                        ...
                        <div id="content">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row d-flex justify-content-center">
                                    ...
                                    <!-- form section start here -->
                                    <h1 class="h3 mb-0 text-gray-800">Your Application Status -   </h1>
                                     <h3><?php echo $approw["status"] ?><h3> </div>
                                     <div class="row d-flex justify-content-center">
                                     <h1 class="h3 mb-0 text-gray-800">For Course ID -   </h1>
                                     <h3><?php echo $approw["c_id"] ?><h3>          
